...
<html>
    ...
    <body class="bg-light">
            ...
            <div class="row mb-5">
                ...
                <div class="col-md-6 card-group col-lg-4 p-2">
                    <div class="card rounded-one shadow">
                        ...
                        <p class="card-footer d-lg-block d-sm-none"><small class="text-muted"><?= $index['created_at']?></small></p>
                    </div>
                </div>
                ...
                <div class="d-block" style="position: absolute;right: 1vw;top: 0;height: 100%;">
                    <div style="position: fixed; bottom: 40px; right: 50px; z-index: 10;" id="rollBack" hidden>
                        <a href="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-arrow-up-circle-fill" viewBox="0 0 16 16" id="biUp">
                                <path d="M16 8A8 8 0 1 0 0 8a8 8 0 0 0 16 0zm-7.5 3.5a.5.5 0 0 1-1 0V5.707L5.354 7.854a.5.5 0 1 1-.708-.708l3-3a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1-.708.708L8.5 5.707V11.5z"/>
                            </svg>
                        </a>
                        <a href="">
                            <svg style="color: #ffffff; display: none;" xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-arrow-up-circle-fill" viewBox="0 0 16 16" id="biUp-white">
                                <path d="M16 8A8 8 0 1 0 0 8a8 8 0 0 0 16 0zm-7.5 3.5a.5.5 0 0 1-1 0V5.707L5.354 7.854a.5.5 0 1 1-.708-.708l3-3a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1-.708.708L8.5 5.707V11.5z"/>
                            </svg>
                        </a>
                    </div>
        ...
        if(moon.hidden) {
            document.getElementById('biUp-white').style.display = 'block';
            document.getElementById('biUp').style.display = 'none';
        } else {
            document.getElementById('biUp-white').style.color = 'none';
            document.getElementById('biUp').style.display = 'block';
        };
